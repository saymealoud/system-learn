...
class TubatuScrapyProjectSpiderMiddleware(object):
...
class TubatuScrapyProjectDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class my_proxy(object):
    def process_request(self,request,spider):
        #proxy，主机头和端口号
        request.meta['proxy'] = 'b5.t.16yun.cn:6460'
        #用户名:密码
        proxy_name_pass = '16GCAQYD:917750'.encode('utf-8')
